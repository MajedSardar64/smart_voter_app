...
class _HomeShellState extends State<HomeShell> {
  ...
  void _switchSearchMode(int mode, String title) {
    ...
    setState(() {
      ...
      _pageTitle = title;
      _currentBody = SearchView(
        key: ValueKey('search_view_$mode'),
        searchMode: mode,
      );
    });
  }
    ...
    Widget mainContent = PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        ...
        final shouldExit = await showDialog<bool>(
          ...
          builder: (ctx) => AlertDialog(
            ...
            content: const Text('আপনি কি সত্যিই অ্যাপটি বন্ধ করতে চান?'),
            actions: [
              TextButton(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomNavigationBar(
          currentIndex: _activeMenuIndex == 0
              ? 0
              : (_activeMenuIndex == 2
                    ? 1
                    : (_activeMenuIndex == 1
                          ? 2
                          : (_activeMenuIndex == 4 ? 3 : 0))),
          selectedItemColor: const Color(0xFF00695C),
          unselectedItemColor: Colors.grey,
          type: BottomNavigationBarType.fixed,
          onTap: (index) {
            if (index == 0) _goToOverview();
            if (index == 1) _switchSearchMode(0, 'ভোটার নাম দিয়ে অনুসন্ধান');
            if (index == 2) _switchSearchMode(1, 'জন্ম তারিখ দিয়ে অনুসন্ধান');
            if (index == 3) _switchSearchMode(2, 'হোল্ডিং দিয়ে অনুসন্ধান');
          },
          items: const [
